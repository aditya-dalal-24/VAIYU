...
public class CycloneDetailResponse {
    private UUID id;
    ...
    private CycloneObservationResponse latestObservation;
    ...
    public CycloneObservationResponse getLatestObservation() { return latestObservation; }
    public void setLatestObservation(CycloneObservationResponse latestObservation) { this.latestObservation = latestObservation; }
}
