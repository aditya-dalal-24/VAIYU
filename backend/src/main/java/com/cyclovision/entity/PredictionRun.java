...
public class PredictionRun {
    ...
    @OrderBy("forecastHours ASC")
    @Builder.Default
    private List<PredictionTrackPoint> trackPoints = new ArrayList<>();

    @OneToMany(mappedBy = "run", cascade = CascadeType.ALL, orphanRemoval = true)
    @OrderBy("forecastHours ASC")
    @Builder.Default
    private List<PredictionIntensityPoint> intensityPoints = new ArrayList<>();

    @OneToMany(mappedBy = "run", cascade = CascadeType.ALL, orphanRemoval = true)
    @OrderBy("rankOrder ASC")
    @Builder.Default
    private List<AnalogueMatch> analogueMatches = new ArrayList<>();

    @OneToMany(mappedBy = "run", cascade = CascadeType.ALL, orphanRemoval = true)
    @OrderBy("forecastHours ASC")
    @Builder.Default
    private List<AnalogueForecastPoint> analogueForecast = new ArrayList<>();
