...
public class Cyclone {
    ...
    public List<CycloneObservation> getObservations() { return observations; }
    public void setObservations(List<CycloneObservation> observations) { this.observations = observations; }
    ...
    public List<CyclonePrediction> getPredictions() { return predictions; }
    public void setPredictions(List<CyclonePrediction> predictions) { this.predictions = predictions; }
}
